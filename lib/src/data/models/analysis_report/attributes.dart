...
class Attributes {
  ...
  String? asOwner;
  LastHttpsCertificate? listHttpsCertificate;

  Attributes({
    this.date,
    this.status,
    this.stats,
    this.listHttpsCertificate,
  ...
  Attributes.fromJson(Map<String, dynamic> json) {
    ...
    listHttpsCertificate = json['last_https_certificate'] != null
        ? LastHttpsCertificate.fromJson(json['last_https_certificate'])
        : null;
